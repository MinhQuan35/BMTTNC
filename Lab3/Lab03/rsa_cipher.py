...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        # Đúng tên nút từ file giao diện
        self.ui.btnKey.clicked.connect(self.call_api_gen_keys)
        ...
        self.ui.btnVirify.clicked.connect(self.call_api_verify)  # Lưu ý: btnVirify có lỗi chính tả
